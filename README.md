...
| `reference/` | Three reference pages — the artifact catalogue, the risk-tier schedule, and Continuous Operations with the expansion streams (rendered from PLAN-001 sections 8 and 11): cross-page lookups that the manuals cite rather than restate |
