...
| `phases/` | Five phase manuals — architecture to production: what agents code and humans monitor per delivery phase. The overview renders `docs/architecture/BIZTRUST-PLAN-001.md`; the P0 page renders its section 4; the P1 and P2 pages render its sections 5 and 6; the P3 page still renders `docs/architecture/DELIVERY_PLAN.md` v0.1 until its ticket moves it; `tests/test_phase_pages.py` holds each page's epic identifiers to the plan section named for it and gate identifiers to PLAN-001 |
