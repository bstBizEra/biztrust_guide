...
**Three kinds.** A *seat* is a human who holds authority: the seat grants implementation authority per Work Package, records a gate, accepts an ADR or a profile, and may be dissented from on the record. A *role* is a responsibility within one stage, named on that stage's roles table and held by a human or an agent as the stage says; a role holds no authority of its own and acts under a seat's grant. A *persona* is an agent identity under the orchestrator; a persona holds no authority, is granted implementation authority per Work Package by a seat, and never records a gate. The hub's eight groups are *lenses*: a lens is held by seats, roles and personas together and is not itself any of them. The roadmap's section 8H binds every agent by identity, assigned Work Package, authority, permitted tools, evidence requirement, independent review, gate and human authorisation when required; the table says how each kind is bound.

| Kind | Held by | Authority | Bound by (roadmap 8H) |
|---|---|---|---|
| Seat | A named human, recorded per seat in the review-seat register (#94) | Grants and records | Identity: a name. Evidence: a dated record with reasons and any dissent. Independent review: another seat may dissent, on the record. Gate: the seat records it. Human authorisation: the seat is it. |
| Role | Whoever the Work Package names to it, human or agent | None of its own | Identity per Work Package; assigned Work Package; evidence; independent review: the role that produces is never the role that verifies the same artifact. |
...
**The seats** are the humans the guide already names, gathered under one name each. The phase pages' *sponsor*, *business sponsor* and *business authority* are one seat; their *architecture authority* is the accountable architecture owner. The hub renders this table.
...
| Insurance practitioner | #27 seat 2 | Domain UAT for the broker core; co-records BT-G2 |
| Legal and compliance reviewer for the jurisdiction | #27 seat 3 | ADR-014 with the finance seat; the compliance track's questions; a dedicated-tenant requirement under E5 |
| Finance and accounting reviewer | #27 seat 4 | BT-G4 with release authority; ADR-014 and the chart of accounts with the legal seat |
| Accountable architecture owner | #27 seat 5; the phase pages' architecture authority is this seat | BT-G0 and BT-G6; acceptance of ADRs; provider selections; P3's three local definitions |
...
| SRE lead | The phase pages' SRE | Co-records BT-G3 and the readiness behind BT-G7; the disaster-recovery exercise's sign-off |
| Repository administrator | AGENTS.md; the hub's NS-003 to NS-005 | Protection of main, Pages and the governing issue |
...
| Architecture Council: principal, insurance, security, data, finance and API architects, product and UX | Architecture, with Product & Domain | Lenses held by personas or humans; chaired by the accountable architecture owner seat, who accepts what the council proposes |
